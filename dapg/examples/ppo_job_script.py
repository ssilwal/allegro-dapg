...
assert any([job_data['algorithm'] == a for a in ['NPG', 'BCRL', 'DAPG','PPO']])
...
if job_data['algorithm'] != 'NPG' and job_data['algorithm'] != 'PPO':
    print("========================================")
...
rl_agent = PPO(e, policy, baseline, save_logs=True, **job_data['alg_hyper_params'])
